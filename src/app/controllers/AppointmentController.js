...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    /* Verifica se o usuário que está tentando fazer um agendamento tem o mesmo
    id do provider */
    if (provider_id === req.userId) {
      return res
        .status(401)
        .json({ error: 'Appointment are not permitted for the same provider' });
    }
